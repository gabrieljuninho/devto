    ...
    <div className="flex-auto overflow-visible text-lg">
      <div>
        <div className="mx-auto my-0 grid w-full max-w-7xl grid-cols-layout-1 gap-2 p-0 text-base md:grid-cols-layout-2 md:p-2 lg:grid-cols-layout-3 lg:gap-4 lg:p-4">
          <div className="row-end-[initial] block w-60 min-w-0">
            <aside>
              ...
              <div className="mb-4 flex justify-start">
                ...
                >
                  <svg
                    ...
                    className="fill-current align-bottom"
                  >
                    <title id="akwt7bxczdjr500nqbjlotb5w0jwgq3r">
                      Facebook
                    </title>
                ...
                >
                  <svg
                    ...
                    className="fill-current align-bottom"
                  >
                    <title id="akjbw1wuxkfju8mqrb5zevgok8hnct74">
                      Instagram
                    </title>
                ...
                >
                  <svg
                    ...
                    className="fill-current align-bottom"
                  >
                    <title id="a8vrt9677hs2tofbxwit1g7odquo2unj">
                      Mastodon
                    </title>
              ...
              <div>
                <div>
                  <div className="overflow-wrap-anywhere max-h-billboard rounded-card bg-white p-3 pb-4 text-primary shadow-[0_0_0_1px_rgba(23,23,23,0.05)]">
                    ...
                    <div className="break-words p-1 pt-3 text-base">
                      <h2 className="my-heading mx-0 text-[1.5em] font-bold leading-tight text-primary">
                        <Link
                          href={
                      ...
                      <p>
                        Showcase your brand with organization branding, engage
                        with your audience, and gain insights with advanced
                        analytics. Join a community that includes industry
                        leaders like Microsoft Azure and DigitalOcean.
                        <br />
                        <Link
                          href={"/"}
              ...
              <footer className="text-secondary mt-6 text-sm">
                <p>
                  <Link
                    href={"/"}

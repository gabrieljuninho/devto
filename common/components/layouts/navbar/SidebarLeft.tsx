...
const SidebarLeft = () => {
  return (
    <div className="fixed inset-0 z-[200] hidden">
      <div className="fixed z-[1] h-full w-[90%] max-w-[300px] overflow-y-auto bg-white">
        <header className="flex min-h-14 items-center justify-between pl-4 pr-2">
          <h2 className="flex-1 break-words text-lg font-bold leading-tight">
            DEV Community
          </h2>
          <button
            type="button"
            className="overflow-wrap-normal relative inline-block shrink-0 rounded-md p-2 text-center text-normal hover:bg-hover hover:text-hover"
          >
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="aqgnulp28wimmwtj6mq4gha7hbk5m2w0"
              aria-hidden="true"
              className="pointer-events-none fill-current align-bottom"
            >
              <title id="aqgnulp28wimmwtj6mq4gha7hbk5m2w0">Close</title>
          ...
          <div>
            <div className="overflow-wrap-anywhere rounded-card bg-white p-4 text-primary shadow-[0_0_0_1px_rgba(23,23,23,0.05)]">
              ...
              <div>
                <Link
                  href={"/"}
                  className="overflow-wrap-normal relative mb-1 inline-flex w-full justify-center rounded-md border border-cta-branded px-border-1-md py-border-1-sm text-center font-medium text-cta-branded outline-0 hover:border-hover hover:bg-cta-branded hover:text-white hover:underline"
                >
                  Create account
                </Link>
                <Link
                  href={"/"}
                  className="overflow-wrap-normal relative flex max-w-full justify-center rounded-md px-4 py-2 text-primary outline-0 hover:bg-hover hover:text-cta-branded hover:underline"
                >
                  Log in
                </Link>
              </div>
            ...
            <nav className="my-4">
              <ul>
                <li>
                  <Link
                    href={"/"}
                    className="overflow-wrap-normal relative flex max-w-full rounded-md px-4 py-2 text-primary outline-0 hover:bg-hover hover:text-cta-branded hover:underline"
                  >
            ...
            <nav className="mb-4">
              <h2 className="py-2 pl-3 text-base font-bold leading-tight text-base-90 sm:leading-normal">
                Other
              </h2>
              <ul>
                <li>
      ...
      <div className="absolute inset-0 bg-base-100 opacity-50"></div>
    </div>
  );
};
